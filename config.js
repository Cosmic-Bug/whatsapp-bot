...
module.exports = {
    ...
    WARN_MSG: process.env.WARN_MSG === undefined ? "Vilachil edukkaruth kettoo" : process.env.WARN_MSG,
    ANTIJID: process.env.ANTIJID === undefined ? '' : process.env.ANTIJID,
    STICKER_PACKNAME: process.env.STICKER_PACKNAME === undefined ? 'Buggy👾' : process.env.STICKER_PACKNAME,
